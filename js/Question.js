class Question {
  ...
  constructor() {
    ...
    this.input2 = createInput("Digite o LETRA da Opção Correta...");
  ...
  display(){
    this.title.html("Questionario mó simples vey");
    ...
    this.question.html("Pergunta:- Onde é que tem dois sete, dois zeros?" );
    // question.html("Pergunta:- O que é que está no meio do começo, no começo do meio, e no final do fim? " );

    this.question.position(150, 80);
    this.option1.html("A): 7700  " );
    this.option1.position(150, 100);
    this.option2.html("B): 2720" );
    this.option2.position(150, 120);
    this.option3.html("C): 2700" );
    this.option3.position(150, 140);
    this.option4.html("D): 7720" );
